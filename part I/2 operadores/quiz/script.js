...
const quest = [{
    title: 'Selecione a alternativa com o\n resultado da expressão: console.log(\'123\' == 123)',
    questions: [{asnwer: 'True', isCorrect: 1122}, {asnwer: 'False', isCorrect: 1223}],
    correct: 1122
},{
    title: 'Selecione a alternativa com o resultado da expressão:\n console.log(\'404\' === 404)',
    questions: [{asnwer: 'True', isCorrect: 112332}, {asnwer: 'False', isCorrect: 1122}],
    correct: 1122
},{
    title: 'Qual é o resultado do comando:\nconsole.log(6>=5)',
    questions: [{asnwer: 'False', isCorrect: 1678}, {asnwer: 'True', isCorrect: 1122}, {asnwer: '5', isCorrect: 4546}],
    correct: 1122
},{
    title: 'Qual é o resultado do comando:\nconsole.log((3+1+1)>=5)',
    questions: [{asnwer: 'True', isCorrect: 1122}, {asnwer: 'False', isCorrect: 1122}, {asnwer: '5', isCorrect: 4546}],
    correct: 1122
},{
    title: 'Qual é o resultado do comando:\nconsole.log(31<=21)',
    questions: [{asnwer: 'True', isCorrect: 8899}, {asnwer: 'False', isCorrect: 1122}],
    correct: 1122
},{
    title: 'Qual será o retorno para\nBoolean(123  ||  \'\')',
    questions: [{asnwer: 'True', isCorrect: 1122}, {asnwer: 'False', isCorrect: 1442}],
    correct: 1122
},{
    title: 'Qual será o retorno para\nBoolean(false  ||  \'\')',
    questions: [{asnwer: 'True', isCorrect: 1678}, {asnwer: 'False', isCorrect: 1122}],
    correct: 1122
},{
    title: 'Qual será o retorno para\nBoolean(true  &&  123)',
    questions: [{asnwer: 'True', isCorrect: 1122}, {asnwer: 'False', isCorrect: 7689}],
    correct: 1122
},{
    title: 'Qual será o retorno para\nBoolean(\'nome\'  &&  undefined)',
    questions: [{asnwer: 'True', isCorrect: 8899}, {asnwer: 'False', isCorrect: 1122}],
    correct: 1122
},]
